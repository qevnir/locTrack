    ...
    <div>
        ...
        <div v-if="showLocations">
            <!--             <table>
                 ...
                 <td>
                 <div class="editButton" v-on:click="editLocation">
            ...
            -->
            <div v-for="location in locations" :key="location.properties.pk" class="location-item">
...
<style>
 ...
 .location-item {
     ...
     margin-bottom: 8px; /* Adjusts space between items */
 }
